...
def make_call(to_number: str, audio_url: str = None, text_to_say: str = None):
    ...
    if audio_url:
        ...
        if "6 Lakh" in text_to_say:
            spoken_text = 'छह लाख की मेहनत करके, <break time="400ms"/> पैंतीस लाख के सपने <emphasis level="strong">नहीं</emphasis> देखे जाते! <break time="500ms"/> <prosody rate="fast" volume="x-loud" pitch="low">DSA सॉल्व कर चल!</prosody>'
        else:
